...
class MgsHandler extends MsgHandlerBase {
    ...
    _sendQuestion() {
        ...
        msg.data = {
            for: this._game.rooms[this._conn.profile.room].turn,
            question: questions[this._game.rooms[this._conn.profile.room].lastQuestion]
        };
        this._game.rooms[this._conn.profile.room].lastQuestion++;
